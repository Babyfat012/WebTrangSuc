...
echo'</tr>';
    ...
    if($result->num_rows > 0)
    {
        ...
        while ($row = $result->fetch_array())
        {
            ...
            {
                echo "<form method='get' action='lockUser.php'>";
                echo'<td>';
                echo '<a href="quantri.php?page_layout=lockUser&temptk='.$row['taikhoankh'].'"><i class="ti-lock"></i></a>';
                echo'</form>';
                echo'</td>';
            }
            else
            {
                echo "<form method='get' action='lockUser.php'>";
                echo'<td>';
                echo '<a href="quantri.php?page_layout=lockUser&temptk='.$row['taikhoankh'].'"><i class="ti-unlock"></i></a>';
                echo'</form>';
                echo'</td>';
            }
