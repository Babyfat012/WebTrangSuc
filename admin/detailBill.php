                            ...
                            <?php
                                ...
                                if($DETAIL->num_rows > 0){
                                    while($detail = $DETAIL->fetch_array()){
                                        ...
                                        echo '<tr>';
                                        echo '<td class="pro-thumbnail"><a href="single-product.php?id='.$product['idsanpham'].'"><img class="img-fluid" src="'.$folder.$product['hinhanh'].'"
                                                                       alt="Product"/></a></td>';
                                        echo '<td class="pro-title"><a href="single-product.php?id='.$product['idsanpham'].'">'.$product['tensp'].'</a></td>';
                                        echo '<td class="pro-price"><span>$'.number_format($detail['dongia'],2,".",",").'</span></td>';
                                        echo '<td class="pro-quantity">'.$detail['soluong'].'</td>';
                                        echo '<td class="pro-subtotal"><span>$'.number_format($detail['soluong']*$detail['dongia'],2,".",",").'</span></td>';
                                        echo '</tr>';
                                    }
                                }
                            ?>
